...
for spacing in spacings:
    ...
    data_p['q25'].append(df_i['noise'].quantile(0.25))
    data_p['q75'].append(df_i['noise'].quantile(0.75))
    data_p['q05'].append(df_i['noise'].quantile(0.05))
    data_p['q95'].append(df_i['noise'].quantile(0.95))
    data_p['q005'].append(df_i['noise'].quantile(0.005))
    data_p['q995'].append(df_i['noise'].quantile(0.995))
