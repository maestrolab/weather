...
with open('./PLdB_true.csv', mode='a+') as file:
...
temperature_profiles = raw_data[:,5:5+n]
humidity_profiles = raw_data[:,5+n:]

for profile in range(3548,len(elevations)):
    ...
    print("True perceived loudness", loudness)
