'''Script to run the log parametrization process for multiple profiles at a time.
'''
...
latitudes = list(range(43,44))
longitudes = list(range(-105,-95))
...
filename = '%s_%s_%s_%s43_-105_-95_spline_log_rh_rmse.p' % (year, month, day, hour)
