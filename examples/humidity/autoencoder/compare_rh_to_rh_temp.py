...
for i in range(len(n_params)):
    if i == 0:
        filename = 'encoding_dim_and_layer_dim_varied/%i_params_%i_dim' % (n_params[0], dim)
    else:
        filename = 'temp_append_encoding_dim_varied/%i_params_%i_dim_temp_append_constant_mins' % (n_params[0], dim)
